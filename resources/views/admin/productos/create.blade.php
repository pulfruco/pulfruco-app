        ...
        <div class="card shadow-sm">
            <div class="card-body">
                ...
                <form action="{{ route('admin.productos.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        <label for="descripcion_corta" class="form-label">Descripción Corta (Catálogo)</label>
                        <input type="text" class="form-control" id="descripcion_corta" name="descripcion_corta" value="{{ old('descripcion_corta') }}" required>
                    </div>

                    <div class="mb-3">
                        <label for="descripcion_larga" class="form-label">Descripción Larga (Detalle/Beneficios)</label>
                        <textarea class="form-control" id="descripcion_larga" name="descripcion_larga" rows="4" required>{{ old('descripcion_larga') }}</textarea>
                    </div>

                    <div class="mb-3">
    <label for="beneficios" class="form-label">Beneficios (Separar cada beneficio con una nueva línea)</label>
    <textarea class="form-control" id="beneficios" name="beneficios" rows="3">{{ old('beneficios') }}</textarea>
...
<div class="mb-3">
    ...
    <textarea class="form-control" id="presentaciones" name="presentaciones" rows="2">{{ old('presentaciones') }}</textarea>
    <div class="form-text">Ejemplo: 250ml, 500ml, 1L.</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            ...
                            <div class="form-text">Máx 2MB. Formatos: JPG, PNG, GIF.</div>
                        </div>
                    </div>

                    <div class="d-flex justify-content-between">
                        <button type="submit" class="btn btn-pulfruco-primary">Guardar Producto</button>
